...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE alumnos SET numero_control='$numero_control', nombre='$nombre',ap='$ap',am='$am',especialidad='$especialidad',semestre='$semestre',turno='$turno',sexo='$sexo' WHERE id_alumno=$id";
    $mensaje = "Tu registro ha sido actualizado";
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        $mensaje = "Tu informacion no se ha enviado";
        echo "<script type='text/javascript'>
        Swal.fire({
            title: 'Alerta',
            text: '$mensaje',
